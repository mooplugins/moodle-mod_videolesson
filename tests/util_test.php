...
final class util_test extends \basic_testcase {
     ...
     */
    public function test_durationformat(): void {
        // Test zero seconds.
     ...
     */
    public function test_is_youtube_url_valid(): void {
     ...
     */
    public function test_is_youtube_url_invalid(): void {
     ...
     */
    public function test_is_vimeo_url_valid(): void {
     ...
     */
    public function test_is_vimeo_url_invalid(): void {
    ...
    public function test_extract_youtube_video_id(): void {
        ...
        $this->assertEquals(
            'dQw4w9WgXcQ',
            util::extract_youtube_video_id('https://www.youtube.com/watch?v=dQw4w9WgXcQ&feature=share')
        );
    ...
    public function test_extract_vimeo_video_id(): void {
        ...
        $this->assertEquals(
            '123456789',
            util::extract_vimeo_video_id('https://player.vimeo.com/video/123456789')
        );
     ...
     */
    public function test_is_embed_code(): void {
     ...
     */
    public function test_extract_url_from_embed_code(): void {
        ...
        $this->assertEquals(
            ...
            util::extract_url_from_embed_code(
     ...
     */
    public function test_detect_external_source_type(): void {
        ...
        $this->assertEquals(
            'direct_video',
            util::detect_external_source_type('https://example.com/video.mp4')
        );
        ...
        $this->assertEquals(
            'unsupported_embed',
            util::detect_external_source_type(
                '<iframe src="https://player.twitch.tv/?video=123"></iframe>'
            )
        );
     ...
     */
    public function test_is_youtube_embed_url(): void {
     ...
     */
    public function test_is_vimeo_embed_url(): void {
     ...
     */
    public function test_get_youtube_embed_url(): void {
        $videoid = 'dQw4w9WgXcQ';
     ...
     */
    public function test_get_vimeo_embed_url(): void {
        $videoid = '123456789';
     ...
     */
    public function test_is_mpegdash(): void {
     ...
     */
    public function test_is_hls(): void {
